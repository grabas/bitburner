...
export class ShortestPathInGrid implements ISolver<CodingContractName.ShortestPathInAGrid> {
    solve(grid: (1 | 0)[][]): string {
    ...
    getType(): CodingContractName {
        return CodingContractName.ShortestPathInAGrid;
    }
}